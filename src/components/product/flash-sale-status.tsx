...
const FSStatusComp = ({ section }: Props) => {
...
function CountDownComp({ time }: { time: number }) {
  const timerClass =
    "flex h-7 min-w-7 px-1 items-center justify-center bg-orange-500 text-white rounded-lg";
  return (
    <div className="flex items-center space-x-1 text-sm">
      ...
      <div className="text-sm font-bold text-orange-200">:</div>
      <div className={timerClass}>
...
export default memo(FSStatusComp);
